...
<body>
	<div class="container-fluid">
		<div class="row" style="margin-top: 2px; min-height: 50px;">
			<div class="col-md-12" style="background-color: #73f692">
		...
		<div class="row" style="margin-top: 5px; min-height: 500px;">
			<div class="col-md-2"
				style="padding-top: 20px; background-color: #f0f175;">
				<ul class="navbar">
			...
			<div class="col-md-10 split" id="center">
				<div align="center">
					<img alt="" src="/resource/images/adminlogo.jpg"
						class="rounded-circle" width="1000px" height="700px">
				</div>
