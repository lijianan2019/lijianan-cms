		...
		<div class="row passport_bg">
			...
			<div class="col-md-6">
				<div class="passport_r">
					<h3>最新加入的用户：</h3>
					<p align="center">
						<img src="/resource/images/324751.jpg" alt="..."
							class="rounded-circle img-thumbnail" width="150px" height="150px"/> &nbsp;&nbsp;&nbsp;&nbsp;
						<img src="/resource/images/325345.jpg" alt="..."
							class="rounded-circle img-thumbnail" width="150px" height="150px" />
					</p>
				</div>
			</div>
