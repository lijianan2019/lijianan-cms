						...
						<div id="carouselExampleCaptions" class="carousel slide"
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="resource/pic/a.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>青青草原</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="resource/pic/b.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>蓝天白云</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="resource/pic/c.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>绿意盎然</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="resource/pic/d.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>美轮美奂</p>
									</div>
								</div>
								<div class="carousel-item">
									<img src="resource/pic/e.jpg" class="d-block w-100" alt="...">
									<div class="carousel-caption d-none d-md-block">
										<p>人间仙境</p>
									</div>
								</div>
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
					 <c:forEach items="${picInfo.list}" var="p">
						<div class="media">
							<img src="resource/pic/${p.picture }" class="mr-3 rounded" alt="..." style="height: 50px;width: 80px">
							<div class="media-body">
